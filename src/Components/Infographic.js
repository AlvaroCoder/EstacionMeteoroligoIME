  ...
  return (
    <div className='relative bg-blue-gray-300 w-full h-screen flex items-center justify-end'>
        ...
        <div className='z-50 px-4 mr-20 w-[600px] h-1/2  flex items-start justify-center flex-col'>
          <h1 className='bg-[#597C00] rounded-xl p-2 text-blanco font-bold text-2xl px-4 font-volkorn'>Banano Orgánico</h1>
          <h1 className='font-bold text-3xl text-blanco my-2 font-volkorn'>¿Sabías que ..?</h1>
